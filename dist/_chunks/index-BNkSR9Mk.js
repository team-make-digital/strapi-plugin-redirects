...
const ForwardRef$52 = React.forwardRef(SvgCalendar);
...
const ForwardRef$4_ = React.forwardRef(SvgCaretDown);
...
const ForwardRef$4M = React.forwardRef(SvgCheck);
...
const ForwardRef$4K = React.forwardRef(SvgCheckCircle);
...
const ForwardRef$4E = React.forwardRef(SvgChevronLeft);
...
const ForwardRef$4C = React.forwardRef(SvgChevronRight);
...
const ForwardRef$4y = React.forwardRef(SvgClock);
...
const ForwardRef$4c = React.forwardRef(SvgCross);
const ForwardRef$4d = ForwardRef$4c;
...
const ForwardRef$3M = React.forwardRef(SvgExternalLink);
...
const ForwardRef$2G = React.forwardRef(SvgInformation);
...
const ForwardRef$2m = React.forwardRef(SvgLoader);
...
const ForwardRef$24 = React.forwardRef(SvgMinus);
...
const ForwardRef$1c = React.forwardRef(SvgPuzzlePiece);
...
const ForwardRef$_ = React.forwardRef(SvgSearch);
...
const ForwardRef$4 = React.forwardRef(SvgWarningCircle);
...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(ForwardRef$1d, {});
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-jUXMtIZr.js"));
        return App;
      }
    });
    app.registerPlugin({
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-tjYFWgq5.js")) }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
...
exports.ForwardRef$25 = ForwardRef$25;
exports.ForwardRef$2H = ForwardRef$2H;
exports.ForwardRef$2n = ForwardRef$2n;
exports.ForwardRef$3N = ForwardRef$3N;
exports.ForwardRef$4$ = ForwardRef$4$;
exports.ForwardRef$4D = ForwardRef$4D;
exports.ForwardRef$4F = ForwardRef$4F;
exports.ForwardRef$4L = ForwardRef$4L;
exports.ForwardRef$4N = ForwardRef$4N;
exports.ForwardRef$4d = ForwardRef$4d;
exports.ForwardRef$4z = ForwardRef$4z;
exports.ForwardRef$5 = ForwardRef$5;
exports.ForwardRef$53 = ForwardRef$53;
exports.index = index;
