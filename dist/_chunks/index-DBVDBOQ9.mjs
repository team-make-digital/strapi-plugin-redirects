...
const ForwardRef$52 = forwardRef(SvgCalendar);
...
const ForwardRef$4_ = forwardRef(SvgCaretDown);
...
const ForwardRef$4M = forwardRef(SvgCheck);
...
const ForwardRef$4K = forwardRef(SvgCheckCircle);
...
const ForwardRef$4E = forwardRef(SvgChevronLeft);
...
const ForwardRef$4C = forwardRef(SvgChevronRight);
...
const ForwardRef$4y = forwardRef(SvgClock);
...
const ForwardRef$4c = forwardRef(SvgCross);
const ForwardRef$4d = ForwardRef$4c;
...
const ForwardRef$3M = forwardRef(SvgExternalLink);
...
const ForwardRef$2G = forwardRef(SvgInformation);
...
const ForwardRef$2m = forwardRef(SvgLoader);
...
const ForwardRef$24 = forwardRef(SvgMinus);
...
const ForwardRef$1c = forwardRef(SvgPuzzlePiece);
...
const ForwardRef$_ = forwardRef(SvgSearch);
...
const ForwardRef$4 = forwardRef(SvgWarningCircle);
...
const PluginIcon = () => /* @__PURE__ */ jsx(ForwardRef$1d, {});
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-DjyWIyHr.mjs");
        return App;
      }
    });
    app.registerPlugin({
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-DXfB43Ry.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
