...
import { Alert, Typography, Box, useCallbackRef, Flex, Field, Main, Loader, Button, Table, Thead, Tr, Th, Tbody, Td, Checkbox, SingleSelect, SingleSelectOption } from "@strapi/design-system";
import { useIntl } from "react-intl";
import * as React from "react";
import React__default, { useContext, useRef, useCallback, useDebugValue, createContext as createContext$1, useState, createElement, useEffect, useLayoutEffect, useReducer, useMemo } from "react";
import { WarningCircle, CaretDown, Check } from "@strapi/icons";
...
const RedirectSettings = () => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs(Main, { children: [
      /* @__PURE__ */ jsx(Layouts.Header, { title: "Redirect Settings", subtitle: "Configure redirect functionality for your content types" }),
  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    /* @__PURE__ */ jsx(
      Layouts.Header,
      {
        ...
        primaryAction: /* @__PURE__ */ jsx(Button, { onClick: handleSave, loading: saving, startIcon: /* @__PURE__ */ jsx(Check, {}), disabled: saving, children: "Save Settings" })
      }
    ),
    /* @__PURE__ */ jsxs(Layouts.Content, { children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: "1.4rem" }, children: /* @__PURE__ */ jsxs(Table, { colCount: 3, children: [
        /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsxs(Tr, { children: [
          /* @__PURE__ */ jsx(Th, { children: "Status" }),
          /* @__PURE__ */ jsx(Th, { children: "Content Type" }),
          /* @__PURE__ */ jsx(Th, { children: "Slug Field" })
        ] }) }),
        /* @__PURE__ */ jsx(Tbody, { children: contentTypes.map((contentType, i2) => {
          ...
          return /* @__PURE__ */ jsxs(Tr, { children: [
            ...
            /* @__PURE__ */ jsx(Td, { children: contentType.apiID }),
            /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(
              SingleSelect,
              {
                label: "Slug Field",
                ...
                children: stringFields.map((field) => /* @__PURE__ */ jsx(SingleSelectOption, { value: field, children: field }, field))
              }
            ) })
          ] }, contentType.uid);
        }) })
      ] }) }),
      contentTypes.length === 0 && /* @__PURE__ */ jsx(Box, { padding: 8, textAlign: "center", children: /* @__PURE__ */ jsx(Typography, { variant: "omega", textColor: "neutral600", children: "No content types found." }) })
    ] })
  ] });
};
const HomePage = () => {
  const { formatMessage } = useIntl();
  return /* @__PURE__ */ jsx(Main, { children: /* @__PURE__ */ jsx(RedirectSettings, {}) });
};
const App = () => {
